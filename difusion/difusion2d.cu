...
void printInitialVariables(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]);
void printResult(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]);
void initializeHostArrays(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]);
...
void initializeHostArrays(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]) {
  ...
  h_u[xmax/2][xmax/2] = th_complex(10000.0f,0.0f);
  h_u[50][51] = th_complex(550.0f,550.5f);
  h_u[51][50] = th_complex(666.0f,666.5f);
}
void printInitialVariables(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]) {
...
void printResult(th_complex h_u[][xmax], th_complex h_uH[][xmax], th_complex h_c[]) {
  ...
  cout << "sum == " << sum << endl;
  printInitialVariables(h_u, h_uH, h_c);
}
void stdDev_r(ofstream& r, float t, th_complex u[][xmax]) {
  th_complex sum = 0;
  for(int i = 0; i< xmax; i++) {
